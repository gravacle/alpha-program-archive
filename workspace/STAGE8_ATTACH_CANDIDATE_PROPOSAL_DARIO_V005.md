...
CLOSURE_END_BYTE = 00007476   (computed on bytes as a fixed point at seal time)
VERDICT_BEARING_SET = exactly the 27 content-addressed members below
...
ANCHOR_RULE = CLOSURE_MEMBER_CITATION_RULE_V001. No flag name is used as an anchor. Member numbers
  differ between this artifact and the checks; where a check is quoted, ITS numbering is named.
LANE = DARIO   ROLE_THIS_RELAY = CANDIDATE V005 — RESTORATION OF TWO DROPPED BLOCKS (relay 1064)
AUTHORITY = member 02, the ATTACH SUPPLY MANDATE, verified LIVE at seal time. It ratifies NO CONTENT
  and none is entered here.
SUPERSESSION = supersedes V004 (member 03) and, through it, V003, V002, V001 (members 05, 06, 07),
  APPEND-ONLY. ALL FOUR ARE BYTE-UNTOUCHED, verified before and after; the generator refuses to emit
  if any moved.
SCOPE = EXACTLY THE RESTORATION. Two classification blocks I dropped when rewriting section 4 in
  V004 are restored from sealed V003 BY SPAN, extract-and-rehash, byte-identical. Every other V004
  line carries byte-identical; both carriage regions are digested on both sides at section 4.0.3.
ALL_RESULTS = CLAIMED until the opposite-lane check.
SELF_CITATION_BAR = DARIO's own prior outputs are not record witnesses. Members 03, 05, 06 and 07 are
  members ONLY as the superseded subjects and byte sources of this restoration.
LIVE_MEMBERS = NONE.
```

| # | Closed member | SHA-256 | Role |
|---:|---|---|---|
| 01 | `relay_inbox/RELAY_PASTE_1064_CANDIDATE_V005_DARIO_V001.md` | `126ffd716b7b98ded065fd4e6c364803673ad10068cf66c30aa9453d1e3d3966` | assignment |
...
| 03 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V004.md` | `e1388e12d14ed3f39c663c085b72bded1e7f58bf255539ce2e2b115315d031e1` | **V004 — superseded, byte-untouched; source of both carriage regions** |
| 04 | `workspace/STAGE8_ATTACH_CANDIDATE_V004_CHECK_CODEX2_V001.md` | `5f55c27ffb9e08e49f964b9c1640436c5a4631010a1404ec8bb6d8bd622c952c` | **the V004 check — the deviation and its bounded repair** |
| 05 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V003.md` | `82d5c5dd59d1d0d6981a2cde7244c1dad1a66352c4159b8543f0554777abea31` | **V003 — READ-ONLY BYTE SOURCE of the two restored blocks** |
| 06 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V002.md` | `14a811a8d5a507c5d20e26ef40fa53661e22b0b39f869edd68ad700bc3765f82` | V002 — superseded, byte-untouched |
| 07 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V001.md` | `8c257818b55c66aef1842024601c51f3a22599a949db7de4280d7763fc9dcdbc` | V001 — superseded, byte-untouched |
| 08 | `workspace/STAGE8_ATTACH_CANDIDATE_V003_CHECK_CODEX2_V001.md` | `0a3aed6d815ee2795529878be3bf4dcaaab6b841b46df8bddad7e883674849ad` | the V003 check |
| 09 | `workspace/STAGE8_ATTACH_CANDIDATE_V002_CHECK_CODEX2_V001.md` | `56d9c9b68dcde555fe3157a4ae09545418b7b8f35766761a91184a534ce42f1b` | the V002 check |
| 10 | `workspace/STAGE8_ATTACH_CANDIDATE_CHECK_CODEX2_V001.md` | `617e0144c0adfad97ec14ae85fbb76efd9787a63f1c0b77b778c9768c747a528` | the V001 check |
| 11 | `workspace/STAGE8_DESC_OPEN_CONDITIONS_SWEEP_CODEX2_V001.md` | `85514b04912f77e9276aca131b41d62d400a3e555e21492eb43a1df53dd5d588` | the six-check acceptance registry |
| 12 | `relay_inbox/RELAY_PASTE_1049_FRESH_SESSION_BOOTSTRAP_DARIO_V007.md` | `8c6cd83fac688dbdb3398b2c7abe3b044149a1a7ba6a6e102da7355381742084` | governing bootstrap |
| 13 | `supervision/PROGRAM_STATE_BRIEF_V005.md` | `e26f0d16055f3e833307c893704561cfb683065f0798e80e1dc0a9db7ed7799c` | state pin |
| 14 | `workspace/BOUNDARY_INCIDENCE_DYNAMICS_PRINCIPLE_V011.md` | `20a3a17d44e15841baded9eaed3fdbecfde0ecb14bdb8162ea41a8bcd21d1a48` | **`rho_joint` and the quotient — the F14 span** |
| 15 | `workspace/STAGE8_HOLONOMY_FIRST_OPENING_TENSION_ADJUDICATION_EINSTEIN_V001.md` | `8fbdc8300b28166564e4ba32e6747bc643135e25d674cc37da706de3afbbf019` | the emptiness-on-purpose ruling |
| 16 | `workspace/FUNDAMENTAL_BOUNDARY_RECORD_ACTION_PRINCIPLE_V002.md` | `a27a2d571273494a0787e2283734ef1405d74dadfe16d64d3450bb4536e50732` | **the adopted connection — the F15 span** |
| 17 | `workspace/PRIMITIVE_TRANSPORT_ONLY_PHASE_COMPLETE_GENERATOR_PRINCIPLE_V001.md` | `aa2ef0e78a1ad975a04596831eef2ea7587b78c4fa9d979ae8a742308cd7c214` | transport-only entry; `q_primitive=1` |
| 18 | `workspace/STAGE8_RATIFIED_SOURCE_COUPLED_FINITE_N_INFLUENCE_FUNCTIONAL_RESULT_V001.md` | `2cd1ffcefd68ac03c6c09a4eca0dc9fe8d1adc8ac564cc0d050dfd41d79e6d0f` | the exact ratified `D_n S` law; the slot identity |
| 19 | `workspace/STAGE8_GEN_OMEGA_GENERATIVE_ORIGIN_RULE_ADOPTION_PROPOSAL_V003.md` | `1be5f6a7e40c34586f3b5ab78f9129de0b5d2041cb6695b0e549443ddd6c6ee0` | the inherited law presentation. READ ONLY WITH 20 AND 21. |
| 20 | `workspace/MEMBER12_HEADER_OVERLAY_RECORD_V002.md` | `e85f444cbbd32db7cd8a3f794faee38d189f4bd12bd8e8bbfb43d8463c23cd75` | the read rule governing 19 |
| 21 | `supervision/DECISION_OF_RECORD_013_GEN_OMEGA_RATIFIED_FAMILY_LEVEL_2026-08-02_V001.md` | `f2a7838d41b7b7df42ae92bc3d59399ee04bbec65cecadc8a43f6a36ac4756ec` | the ratification; the no-member clause |
| 22 | `workspace/STAGE8_TASK2D_FINITE_N_INFLUENCE_FUNCTIONAL_INSTANCE_CONSTRUCTION_RESULT_V001.md` | `c49d31200460e96209375f06a7a655d343767695ef09805f1e396d1814833b6b` | the Q-227 baseline; `P_0 = I - P_ch` |
| 23 | `workspace/R3_4_CHARGED_INCIDENCE_OUTGOING_STATE_RESULT_V002.md` | `2be95d5b58ea000df9a30b717a809374a90693f78a893d87b73a12e4be97fa21` | the computed cell endpoint |
| 24 | `workspace/R3_4_CAUSAL_CELL_MOVING_FRONT_RESULT_V001.md` | `ed4572ebfece9da2d57a2baede144f996aee1b196c26182c0d9e61f879bf9ef9` | the F10 base pulse; the underived parent |
| 25 | `workspace/R3_4_CAUSAL_TRANSPORTED_WRITE_TAIL_RESULT_V001.md` | `321c52bc3f5cf8d66b2ca4a7f14811a41e905048ef89415f8c76e22837261c58` | the O4 tail anchor |
| 26 | `workspace/R3_4_CHARGED_INCIDENCE_OUTGOING_STATE_SPEC_V002.md` | `4a7600caa23d0c7a98eeef8a79941c20ca4e28a4f5a2c1cf5c2362e88c7d4721` | the charge projector |
| 27 | `workspace/STAGE8_TASK2D_SOURCE_HISTORY_MAP_COVARIANT_INCIDENCE_DERIVATION_ADJUDICATION_V001.md` | `ab156ee764db9d0bd48f54f1b879f1bafcfac08b45520ca6c4fb582e48edf572` | the Attach type; placement nonuniqueness |

```text
RESTORED BY SPAN FROM SEALED V003 (member 05), extract-and-rehash, byte-identical:
  F14 CLASSIFICATION BLOCK   V003 lines 239-254   1,132 B
    749dfe4a7a68efa2c43c870bc8767fcf7ad57c25c6800a324c13e5381455cd33
  F15 CLASSIFICATION BLOCK   V003 lines 257-269     708 B
...
# STAGE 8 — THE ATTACH CANDIDATE, V005 — THE RESTORATION
## RELAY 1064 — `[PLAN:DESC-33]` — DARIO LANE — RESTORATION ONLY — [CLAIMED]

Date: 2026-08-12
Status: **SUPERSEDES V004 APPEND-ONLY.** V004, V003, V002, V001 all byte-untouched.

**WHAT WENT WRONG, AND IT WAS MINE.** V004 claimed "nothing else moves" and then moved something. In
rewriting section 4 to fix the extractor, I replaced V003's section 4 wholesale — and V003's section 4
contained **two forced-row classification blocks**, the `F14` ruling on `rho_joint` and the `F15`
ruling on the connection `A`. Both were dropped. The ledger still *listed* F14 and F15 and the map
still pointed at them, but **the reasoning that classified them was gone from the artifact**, which
means V004 shipped two rows whose justification existed only in a superseded document.

**This is a carriage failure, not a content dispute.** Every substantive claim of V003 survived; what
was lost was the text establishing two of them. The check caught it and specified the bounded repair,
and this version is that repair and nothing else.
...
```text
CLOSURE = declared-first (byte 0; end byte 00007476 computed as a fixed point on bytes; 27 members;
     0 live; residue scan 0 hits from its own run)

F14 = RESTORED-BYTE-IDENTICAL (digest verified)
     V003 lines 239-254, 1,132 B,
     749dfe4a7a68efa2c43c870bc8767fcf7ad57c25c6800a324c13e5381455cd33
     Extracted from sealed V003 BY SPAN and rehashed before insertion; the generator repeats the
     extraction and refuses to seal on any mismatch.  The block's internal V003 numbering is carried
     unchanged rather than renumbered, because renumbering would destroy the byte-identity that is
     the point of the restoration.

F15 = RESTORED-BYTE-IDENTICAL (digest verified)
     V003 lines 257-269, 708 B,
     ed824a3b79b4691964f644e829b7376734dc007167a8707e2882eb31bc4a627e
     Same procedure, same refusal path.

MAP = 35/16/0-CARRIED.  The symbol map, the closed vocabulary, and invariants INV-1..INV-4 sit inside
     carriage region B and carry byte-identical; the generator re-runs the audit over those same
     bytes and reproduces 35 symbols / 16 distinct rows / 0 unmapped.  Nothing about the map or the
     extractor changes in this version.

CARRIAGE = SPANNED (all else byte-identical to V004)
     REGION A  V004 lines 85-242,   7,172 B,
       eb3ed614743fba83e8699d522e07dd5d47d144c8c1dff85bb84177ae219c21af
     REGION B  V004 lines 243-577, 16,379 B,
       7b1e2e324c3e60a734fbbeaa01d1e09154fbd04f91d70f5f28972037c76c0880
     Both digests recomputed from sealed V004 and verified present verbatim in V005; the generator
     refuses on mismatch.  The restoration is an INSERTION — no V004 line is edited, reordered or
     removed.  NO CLAIM, COUNT, ROW, REQUIREMENT, REGISTRY STATUS, RESIDUAL OR INVARIANT CHANGES.

     THE DEVIATION THIS REPAIRS WAS MINE: V004 said "nothing else moves" and dropped two forced-row
     classification blocks while rewriting section 4.  The rows and the map survived; the reasoning
     that classified them did not.  V004's carriage proof could not see it, because a proof scoped to
     the carried regions is silent about the region that was rewritten.

OUTPUT_INSPECTION = NONE-CERTIFIED
PROSE_DIGESTS = 27/27, STRICT==STABLE
CHAIN_INVOKED = true (chained pickup proceeds to RELAY_PASTE_1063_THETA_HIST_BUILD_DARIO_V001.md,
     the earlier unprocessed DARIO paste; 1065 is a CODEX 2 recheck this lane may not obey)
VERB_AUDIT_SELF = CLEAN
...
**What this version is.** V003's content, plus the three-symbol map repair, plus the alias-free
extractor — which is what the prospective decision of record describes. Nothing is added and nothing
is argued. **The three substantive exposures are exactly where they have been since V003:** A6 demands
a two-stage front from a parent nobody has derived, AC-2 is open on the SR representation, and the
operative domain is a mathematical sector no result has shown to be the physical one.

The candidate has now been checked five times. Every pass has either shrunk it or repaired my
bookkeeping; **none has moved those three, and none will**, because they are objects the record has
not built rather than defects in my text. Whether a conditional object carrying them is entry-eligible
remains a principal's question.
