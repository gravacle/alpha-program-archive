...
def main():
    ...
    sources = {
        ...
        "specification": (cleanroom / "STAGE8_TASK6_A35_EVALUATOR_SPEC_LANE2_V011.md", "alpha_fundamental_record_action_cleanroom_v003/STAGE8_TASK6_A35_EVALUATOR_SPEC_LANE2_V011.md"),
        ...
        "verifier_manifest_v010": (cleanroom / "evaluator_build_B/rd22.verifier-manifest.v001.json", "alpha_fundamental_record_action_cleanroom_v003/evaluator_build_B/rd22.verifier-manifest.v001.json"),
        "verifier_v010_resolver_report": (cleanroom / "STAGE8_TASK6_GROUND_ATOM_RESOLVER_DARIO_V001.md", "alpha_fundamental_record_action_cleanroom_v003/STAGE8_TASK6_GROUND_ATOM_RESOLVER_DARIO_V001.md"),
