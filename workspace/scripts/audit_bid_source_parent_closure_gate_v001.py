#!/usr/bin/env python3
"""Structured, fail-closed regression audit for V011 source-parent obligations."""
...
EXPECTED_OBLIGATION_TABLE_SHA256 = (
    "5ab31925cb5cc2950c6033e6894e471f8ccacd53a2ceefcde8a58c78a68b59e5"
)
...
def main() -> None:
    documents = {
        "gate": "BID_SOURCE_PARENT_CLOSURE_GATE_V001.md",
