...
def main() -> None:
    ...
    unexpected_semantic = sorted(SEMANTIC_READS - expected_semantic)
    target_bearing_semantic_reads = unexpected_semantic
    no_target_access = {
        ...
        "unpinned_semantic_reads": [
            str(path) for path in unexpected_semantic
        ],
        ...
        "coupling_value_accessed": bool(target_bearing_semantic_reads),
        "kappa_record_value_accessed": bool(target_bearing_semantic_reads),
        "alpha_value_accessed": bool(target_bearing_semantic_reads),
        "downstream_match_artifact_accessed": bool(
            target_bearing_semantic_reads
        ),
    }
