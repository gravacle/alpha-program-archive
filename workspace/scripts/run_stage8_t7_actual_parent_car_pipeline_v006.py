...
IMPLEMENTATION_MANIFEST = (
    ROOT
    / "provenance/"
    "stage8_t7_actual_parent_regulated_car_operator_response_implementation_v005.json"
)
...
# The ten-row v006 inventory: controller v006, launcher v005, comparator
# v005, the byte-frozen v002 derive lanes, and the five test files
# (test_compare v005, test_launcher v005, test_controller v006, plus the
# byte-frozen v002 derive-lane suites).
...
#   2. implementation_manifest  — the controller's own sealed v005 manifest:
...
# Steps 1-10 all precede the first canonical write; steps 6-9 additionally
# precede any consumption of the canonical comparison path; step 7
# additionally precedes any consumption of the canonical primary path.
PRECONDITIONS = (
    "runtime_attestation",
    "implementation_manifest",
    "authority_digests",
