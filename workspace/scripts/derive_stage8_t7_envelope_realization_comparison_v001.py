#!/usr/bin/env python3
"""Blind ER-A/ER-B comparison on the genuine Hermite-Galerkin parent."""
...
OUT = ROOT / "stage8_execution/work/T07_envelope_realization_comparison.json"
...
def run_case(
    ...
    for mode in ("ER-A", "ER-B"):
        ...
        secondary_m = base.cell_matrices(n, ell, 48, (12, 12, 24))
        ...
        for scheme, secondary in (
            ...
            a12 = stored_complex(amplitudes["12"][scheme])
            ...
            convergence[scheme] = {
                ...
                "secondary_quadrature_difference": float(abs(a48 - secondary)),
            }
        branches[mode] = {
    ...
    a = branches["ER-A"]["amplitudes"]["48"]
    b = branches["ER-B"]["amplitudes"]["48"]
    return {
        "n": n,
        "ell": ell,
        "spinor_dimension": int(h0.shape[0]),
        "branches": branches,
        "ER_A_to_ER_B_absolute_difference_N48": {
...
def main() -> None:
    ...
    result = {
        "schema": "stage8_t7_envelope_realization_comparison_v001",
