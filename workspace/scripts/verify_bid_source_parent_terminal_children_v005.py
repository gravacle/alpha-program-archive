...
def validate_child(
    ...
    require(
        ...
        and sha256(V003_FAILURE_RECORD) == V003_FAILURE_RECORD_SHA256
        and sha256(V003_FAILURE_SEAL) == V003_FAILURE_SEAL_SHA256
        and V003_FAILURE_SEAL.read_text(encoding="utf-8").strip()
        == f"{V003_FAILURE_RECORD_SHA256}  {V003_FAILURE_RECORD.name}",
        "producer manifest does not inherit the preserved v003 failure",
    )
    require(
    ...
    require(
        ...
        "producer manifest file inventory omits preserved v003 failure evidence",
    )
