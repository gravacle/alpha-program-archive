#!/usr/bin/env python3
"""Evaluate the sealed finite-Qspec holonomy response diagnostic."""
...
OUT = ROOT / "stage8_execution/work/QSPEC_finite_holonomy_response.json"
...
def main() -> None:
    ...
    d_fine = duhamel_estimates[fine_steps]["g_Duhamel"]
    d_radius = (
        abs(d_fine - duhamel_estimates[coarse_steps]["g_Duhamel"]) / 3.0
        + 1e-8
    )
    ...
    result = {
        "schema": "complete_qspec_finite_holonomy_response_v001",
