...
OUT = (
    ...
    "QSPEC_periodic_complex_zero_free_v002.json"
)
...
def main() -> None:
    ...
    for theta in (-RADIUS, 0.0, RADIUS):
        ...
        candidate = expm_pade13(-0.5j * dt_check * real_free)
    ...
    result = {
        "schema": "complete_qspec_periodic_complex_zero_free_v002",
