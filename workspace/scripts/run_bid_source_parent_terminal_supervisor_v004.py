...
VERIFIER_BUILDER = (
    ROOT / "scripts" / "build_bid_source_parent_terminal_verifier_manifest_v004.py"
)
NORMAL_MANIFEST = (
    PROJECT_ROOT
    / "provenance"
...
TERMINAL = PROJECT_ROOT / "results" / "bid_source_parent_sp14_terminal_v004.json"
SIGNATURE = PROJECT_ROOT / "results" / "bid_source_parent_sp14_terminal_v004.json.asc"
...
def validate_runtime() -> tuple[dict[str, Any], dict[str, str]]:
    ...
    require(runtime.get("schema") == "gravacle.content-addressed-runtime.v013", "runtime schema")
...
def validate_child(
    ...
    require(
        receipt.get("schema") == "gravacle.sealed-target-child-execution-record.v013"
...
def main() -> None:
    ...
    produced = (
        ...
        PROJECT_ROOT / "provenance" / "bid_source_parent_terminal_producer_normal_v004_execution_receipt.json",
        PROJECT_ROOT / "provenance" / "bid_source_parent_terminal_producer_optimized_v004_execution_receipt.json",
        PROJECT_ROOT / "provenance" / "bid_source_parent_terminal_children_verifier_v004_execution_receipt.json",
    )
    ...
    terminal = {
        "schema": "gravacle.bid-source-parent-sp14-terminal.v004",
