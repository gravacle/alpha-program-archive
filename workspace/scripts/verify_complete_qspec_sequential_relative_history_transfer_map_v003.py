...
OUT = (
    ROOT
    / "stage8_execution/work/"
    "QSPEC_sequential_relative_history_transfer_map_verification_v003.json"
)
...
def main() -> None:
    ...
    protected = all(
        not primary[name]
        for name in (
            "concurrent_open_record_block_map_derived",
    ...
    result = {
        "schema":
            "complete_qspec_sequential_relative_history_transfer_map_verification_v003",
        ...
        "physical_regression_integrity_checked": {
            ...
            "source":
                "hash_locked_primary_Qspec_execution_artifact",
        },
