...
from validate_content_addressed_runtime_evidence_v014 import (  # noqa: E402
...
RECEIPT_KEYS = {
    ...
    "malicious_target_code_resistance_claimed",
    ...
    "reviewed_hash_sealed_target_in_local_tcb",
...
def validate_child(
    ...
    require(
        manifest.get("preserved_failure_lineage") == preserved_failure_lineage(),
        "producer manifest does not inherit the exact preserved failure lineage",
    )
    for record, record_hash, seal, seal_hash in (
        ...
        require(
            ...
            f"preserved failure trust anchor changed: {record.name}",
        )
    require(
    ...
    require(
        ...
        "producer manifest file inventory omits preserved failure evidence",
    )
    ...
    expected_values = {
        "schema": "gravacle.sealed-target-child-execution-record.v014",
        ...
        "reviewed_hash_sealed_target_in_local_tcb": True,
        "malicious_target_code_resistance_claimed": False,
...
def main() -> None:
    ...
    result = {
        ...
        "checks": {
            ...
            "preserved_failure_lineage_validated": True,
