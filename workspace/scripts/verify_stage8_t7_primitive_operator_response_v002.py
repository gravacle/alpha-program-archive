...
OUT = (
    ...
    "T07_primitive_operator_response_verification_v002.json"
)
...
def route1_control():
    ...
    return {
        ...
        "pass": bool(
            max(maximum_completed, maximum_all) <= TOLERANCE
        ),
    }
...
def run() -> dict[str, object]:
    ...
    return {
        "schema": "stage8_t7_primitive_operator_response_verification_v002",
...
def main() -> None:
    atomic_write(
        {
            "schema":
                "stage8_t7_primitive_operator_response_verification_v002",
            "overall_verdict":
