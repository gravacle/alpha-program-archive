...
LANE = DARIO   ROLE_THIS_RELAY = CANDIDATE V004 — THE THREE-SYMBOL MAP FIX (relay 1061)
AUTHORITY = member 02, the ATTACH SUPPLY MANDATE, verified LIVE at seal time. It ratifies NO CONTENT
  and none is entered here.
SUPERSESSION = supersedes V003 (member 03) and, through it, V002 and V001 (members 05, 06),
  APPEND-ONLY. ALL THREE ARE BYTE-UNTOUCHED, verified before and after; the generator refuses to
  emit if any moved.
SCOPE = EXACTLY ONE REPAIR. The symbol map gains its missing entries and the extractor loses its
  exemption mechanism. NOTHING ELSE MOVES: sections 0-3 and 5-7 of V003 are carried BYTE-IDENTICAL
  and the carriage is proved by span digest at section 4.4.
ALL_RESULTS = CLAIMED until the opposite-lane check.
SELF_CITATION_BAR = DARIO's own prior outputs are not record witnesses. Members 03, 05 and 06 are
  members ONLY as the superseded subjects of this repair, never as evidence for any claim.
LIVE_MEMBERS = NONE.
```

| # | Closed member | SHA-256 | Role |
|---:|---|---|---|
| 01 | `relay_inbox/RELAY_PASTE_1061_CANDIDATE_V004_DARIO_V001.md` | `594cece24998ce1a8361f87617d87f56f71cf4165b6cbecfa734e0564233d47f` | assignment |
...
| 03 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V003.md` | `82d5c5dd59d1d0d6981a2cde7244c1dad1a66352c4159b8543f0554777abea31` | **V003 — superseded, byte-untouched; the source of every carried region** |
| 04 | `workspace/STAGE8_ATTACH_CANDIDATE_V003_CHECK_CODEX2_V001.md` | `0a3aed6d815ee2795529878be3bf4dcaaab6b841b46df8bddad7e883674849ad` | **the V003 check — the escape and its specified repair** |
| 05 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V002.md` | `14a811a8d5a507c5d20e26ef40fa53661e22b0b39f869edd68ad700bc3765f82` | V002 — superseded, byte-untouched |
| 06 | `workspace/STAGE8_ATTACH_CANDIDATE_PROPOSAL_DARIO_V001.md` | `8c257818b55c66aef1842024601c51f3a22599a949db7de4280d7763fc9dcdbc` | V001 — superseded, byte-untouched |
| 07 | `workspace/STAGE8_ATTACH_CANDIDATE_V002_CHECK_CODEX2_V001.md` | `56d9c9b68dcde555fe3157a4ae09545418b7b8f35766761a91184a534ce42f1b` | the V002 check |
| 08 | `workspace/STAGE8_ATTACH_CANDIDATE_CHECK_CODEX2_V001.md` | `617e0144c0adfad97ec14ae85fbb76efd9787a63f1c0b77b778c9768c747a528` | the V001 check |
| 09 | `workspace/STAGE8_DESC_OPEN_CONDITIONS_SWEEP_CODEX2_V001.md` | `85514b04912f77e9276aca131b41d62d400a3e555e21492eb43a1df53dd5d588` | the six-check acceptance registry |
| 10 | `relay_inbox/RELAY_PASTE_1049_FRESH_SESSION_BOOTSTRAP_DARIO_V007.md` | `8c6cd83fac688dbdb3398b2c7abe3b044149a1a7ba6a6e102da7355381742084` | governing bootstrap |
| 11 | `supervision/PROGRAM_STATE_BRIEF_V005.md` | `e26f0d16055f3e833307c893704561cfb683065f0798e80e1dc0a9db7ed7799c` | state pin |
| 12 | `workspace/BOUNDARY_INCIDENCE_DYNAMICS_PRINCIPLE_V011.md` | `20a3a17d44e15841baded9eaed3fdbecfde0ecb14bdb8162ea41a8bcd21d1a48` | `rho_joint`, the quotient, both graph carriers |
| 13 | `workspace/STAGE8_HOLONOMY_FIRST_OPENING_TENSION_ADJUDICATION_EINSTEIN_V001.md` | `8fbdc8300b28166564e4ba32e6747bc643135e25d674cc37da706de3afbbf019` | the emptiness-on-purpose ruling |
| 14 | `workspace/FUNDAMENTAL_BOUNDARY_RECORD_ACTION_PRINCIPLE_V002.md` | `a27a2d571273494a0787e2283734ef1405d74dadfe16d64d3450bb4536e50732` | the adopted connection; holonomy normalization |
| 15 | `workspace/PRIMITIVE_TRANSPORT_ONLY_PHASE_COMPLETE_GENERATOR_PRINCIPLE_V001.md` | `aa2ef0e78a1ad975a04596831eef2ea7587b78c4fa9d979ae8a742308cd7c214` | transport-only entry; `q_primitive=1` |
| 16 | `workspace/STAGE8_RATIFIED_SOURCE_COUPLED_FINITE_N_INFLUENCE_FUNCTIONAL_RESULT_V001.md` | `2cd1ffcefd68ac03c6c09a4eca0dc9fe8d1adc8ac564cc0d050dfd41d79e6d0f` | the exact ratified `D_n S` law; the slot identity |
| 17 | `workspace/STAGE8_GEN_OMEGA_GENERATIVE_ORIGIN_RULE_ADOPTION_PROPOSAL_V003.md` | `1be5f6a7e40c34586f3b5ab78f9129de0b5d2041cb6695b0e549443ddd6c6ee0` | the inherited law presentation. READ ONLY WITH 18 AND 19. |
| 18 | `workspace/MEMBER12_HEADER_OVERLAY_RECORD_V002.md` | `e85f444cbbd32db7cd8a3f794faee38d189f4bd12bd8e8bbfb43d8463c23cd75` | the read rule governing 17 |
| 19 | `supervision/DECISION_OF_RECORD_013_GEN_OMEGA_RATIFIED_FAMILY_LEVEL_2026-08-02_V001.md` | `f2a7838d41b7b7df42ae92bc3d59399ee04bbec65cecadc8a43f6a36ac4756ec` | the ratification; the no-member clause |
| 20 | `workspace/STAGE8_TASK2D_FINITE_N_INFLUENCE_FUNCTIONAL_INSTANCE_CONSTRUCTION_RESULT_V001.md` | `c49d31200460e96209375f06a7a655d343767695ef09805f1e396d1814833b6b` | the Q-227 baseline; `P_0 = I - P_ch` |
| 21 | `workspace/R3_4_CHARGED_INCIDENCE_OUTGOING_STATE_RESULT_V002.md` | `2be95d5b58ea000df9a30b717a809374a90693f78a893d87b73a12e4be97fa21` | the computed cell endpoint |
| 22 | `workspace/R3_4_CAUSAL_CELL_MOVING_FRONT_RESULT_V001.md` | `ed4572ebfece9da2d57a2baede144f996aee1b196c26182c0d9e61f879bf9ef9` | **the F10 base pulse: `B_j`, `v_j`, `tau_R`; the underived parent** |
| 23 | `workspace/R3_4_CAUSAL_TRANSPORTED_WRITE_TAIL_RESULT_V001.md` | `321c52bc3f5cf8d66b2ca4a7f14811a41e905048ef89415f8c76e22837261c58` | the O4 tail anchor |
| 24 | `workspace/R3_4_CHARGED_INCIDENCE_OUTGOING_STATE_SPEC_V002.md` | `4a7600caa23d0c7a98eeef8a79941c20ca4e28a4f5a2c1cf5c2362e88c7d4721` | the charge projector |
| 25 | `workspace/STAGE8_TASK2D_SOURCE_HISTORY_MAP_COVARIANT_INCIDENCE_DERIVATION_ADJUDICATION_V001.md` | `ab156ee764db9d0bd48f54f1b879f1bafcfac08b45520ca6c4fb582e48edf572` | the Attach type; placement nonuniqueness |
| 26 | `workspace/STAGE8_AXN_STATE_ALGEBRA_MAP_CODEX2_V001.md` | `a67ed4352e939bd92e886672b9dfdb848cfcaa453a3760f0daa83d6586d60782` | `res_B`; the AC6 gap |
...
# STAGE 8 — THE ATTACH CANDIDATE, V004 — THE THREE-SYMBOL MAP FIX
## RELAY 1061 — `[PLAN:DESC-33]` — DARIO LANE — ONE REPAIR — [CLAIMED]

Date: 2026-08-12
Status: **SUPERSEDES V003 APPEND-ONLY.** V003, V002 and V001 all byte-untouched.
**Exactly one repair. Sections 0–3 and 5–7 are carried BYTE-IDENTICAL from V003 and the carriage is
proved by span digest at §4.4.**

**THE LESSON, in one sentence:** three failures of the closed claim — two by prose review, one by my
own aliased extractor — establish that **the extractor must be generic and the map must be total,
because an exemption list inside a completeness check is precisely the defect that check exists to
catch.**
...
MAP = B_j,v_j -> F10 ; w_j -> A6.  The check's own assignment, adopted without amendment: B_j and
     v_j are source objects of the carried forced base-pulse row, w_j is load-bearing authored data
     belonging to A6.  No row was created, moved, or re-typed; the row census is unchanged.

ALIASES = DELETED.  Not the three entries — THE MECHANISM.  The extractor now runs generic over
     every letter-initial identifier with NO alias set and NO hard-coded inventory, under four
     enforced invariants: no vocabulary entry may contain "_" (INV-1) or be a single character
     (INV-2); vocabulary and map must be disjoint (INV-3); and every "_"-bearing or single-character
     token MUST be mapped (INV-4).  INV-1 AND INV-4 TOGETHER WOULD HAVE CAUGHT THIS RELAY'S ESCAPE
     UNAIDED, which is the property that makes the repair structural rather than cosmetic.
...
CARRIAGE = SPANNED (untouched regions byte-identical)
     REGION A, V003 sections 0-3, lines 81-236, 7,090 B,
       1d14a748ce71a4ea32dc72566fefb978f24a61a3c5327596ad2e1be701413665
     REGION B, V003 sections 5-7, lines 318-429, 5,593 B,
       e716d80672b25499fed2ef088614051cc7fa3a6abf47508beca443e33def64b0
     REGION B CONTAINS THE CONSTRUCTION BLOCK, so the audit ran over the same bytes V003's audit ran
     over: the improved result is attributable to the extractor and the map, not to a rewritten
     subject.  Both digests recomputed on both sides; the generator refuses to seal on a mismatch.
...
its check's digest, **no construction may consume this candidate as premise.** Forcing slot
unchanged: `future_derivation_can_select_the_attach_map = NO_VERDICT`.

All findings **CLAIMED** until the opposite-lane check.

**What I would say to the check.** This version fixes a checker, not a candidate. The three
substantive exposures named at the end of V003 are untouched and remain exactly where they were:
A6 demands a two-stage front from a parent nobody has derived, AC-2 is open on the SR representation,
and the operative domain is a mathematical sector no result has shown to be the physical one. **No
further pass over my own text will produce any of them.** The candidate has now been checked four
times and has shrunk at every pass; what is left to test is not my prose but whether a conditional
object carrying those three is entry-eligible at all — and that remains a principal's question.
