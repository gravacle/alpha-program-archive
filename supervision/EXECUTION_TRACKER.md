...
| 660 | Codex 2 | [6/BUILD] parent: ledger is run-scoped — sentinel-tolerate pre-run, bind post-production (Q-597 semantics) | **SENT** |
| 661 | Dario | [6/BUILD] one string: output_path -> verifier.output.json (the parent's actual constant) | LOADED — NOT SENT |
