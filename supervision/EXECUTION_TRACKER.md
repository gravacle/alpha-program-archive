...
| 1105 | Dario | [PLAN:DESC-49/ASSEMBLE] SURFACE-GUIDED COUPLING ASSEMBLY (re-issue of 1103) | STAGED-READY. Same surface-guided intent: assemble the coupling from the record's OWN derived terms + OWN structure; assembles easily -> RIGHT PATH (Finish-A live); else classify each obstruction SURFACE-REAL vs MACHINERY-INDUCED; all-machinery-induced -> WRONG PATH (drop the machinery); a surface-real gap -> Finish-B-SHARP. Fresh number so no cached paste can be run |
