...
| 1100 | Codex 2 | [PLAN:DESC-47/REQUIRE-SIDE] PRINCIPLE-FIXES CHECK | STAGED-READY (attack both clearing dirs: is the self-gravitation selector actually non-circular / is there a 2nd selector (→B1 now)? and is the type actually TYPE-R forbidden (fatal), not TYPE-U demanded? verify one-chain-in-series + the stationarity-inherits-circularity risk) |
