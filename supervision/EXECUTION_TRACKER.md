...
| 1029 | Dario | [PLAN:DESC-25] B03 V002 — port reframed to the record's own demand; does the forced d_state object satisfy it? | QUEUED (chains behind 1027, guarded) — PRINCIPAL PAUSE RULE (Brian, 2026-08-11): on any outcome other than a clean PORT-CLOSES, the pipeline STOPS at this relay; result presented raw to the principal before any further relay is authored; on clean close, only the mechanical opposite-lane check is queued |
