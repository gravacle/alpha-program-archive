...
| 1103 | — | [PLAN:DESC-49] LOG REFERENCE-SCALE HUNT | VOIDED before running — its premise (the record-native object carries an A_4 log) was corrected away by 1102 (the log is OWED, at the far end of the completion stack, not present). No shortcut; the gap is the whole completion stack |
