...
| 1098 | Codex 2 | [PLAN:DESC-46/REQUIRE-SIDE] DERIVED-SCALE CHECK | STAGED-READY (clearing direction: is a length REALLY not constructible from the sealed derived content — any other derived dimensionful quantity, any sealed action↔length identification, any second equation? verify the two named primitives + inventory-relative quantifier + singular toll) |
